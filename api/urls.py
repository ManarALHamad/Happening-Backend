...
urlpatterns = [
    ...
    path("profile/image", views.profile_image_upload,name="profile-image-upload"), #profile image
    ...
    path("startups/<int:startup_id>/logo", views.startup_logo_upload, name="startup-logo-upload"), #logo upload
